...
class MainFrame(tkinter.ttk.Frame):
    ...
    def __createGUI(self):
        ...
        if platform.system() == "Windows": 
            ...
            tkinter.font.nametofont("TkDefaultFont").config(family= "Helvetica", size = 9)
            tkinter.font.nametofont("TkTextFont").config(family= "Helvetica", size = 9)
        ...
        # "Show manual" button
        self.button_info = tkinter.ttk.Button(self.frame_controls, text ="Show manual",  width = 15, command= self.onInfo)
        self.button_info.grid(row=1, column = 1, columnspan=2, pady=(5,2))

        # "Clear all" button
        self.button_clear = tkinter.ttk.Button(self.frame_controls, text ="Clear all", width = 8, command = self.onClear)
        self.button_clear.grid(row=2, column = 2, padx=(5,10), pady=2)

        # "Load dataset" button
        self.button_load = tkinter.ttk.Button(self.frame_controls, text ="Load dataset", width = 12, command= self.onLoad)
        ...
        self.text_results = tkinter.Text(self.frame_results, height=10, width=10, yscrollcommand= self.scroll_results.set, state="disabled")
